...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Apple-II_MiSTer.git"
CORE_NAME=(Apple-II)
...
UPSTREAM_CORE_NAME=(Apple-II)
MAIN_BRANCH="master"
UPSTREAM_BRANCH="master"
COMPILATION_INPUT=(Apple-II.qpf)
COMPILATION_OUTPUT=(output_files/Apple-II.rbf)
